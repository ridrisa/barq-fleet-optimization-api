/**
 * Unit Tests for planning.agent.js
 */

const Planning.agent = require('../../../src/agents/planning.agent.js');

describe('planning.agent Agent', () => {
  let agent;

  beforeEach(() => {
    agent = new Planning.agent();
  });
  ...
  describe('Constructor', () => {
    test('should initialize successfully', () => {
      ...
      expect(agent).toBeInstanceOf(Planning.agent);
    });
  });
