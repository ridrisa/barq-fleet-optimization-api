/**
 * Unit Tests for order-assignment.agent.js
 */

const OrderAssignment.agent = require('../../../src/agents/order-assignment.agent.js');

describe('order assignment.agent Agent', () => {
  let agent;

  beforeEach(() => {
    agent = new OrderAssignment.agent();
  });
  ...
  describe('Constructor', () => {
    test('should initialize successfully', () => {
      ...
      expect(agent).toBeInstanceOf(OrderAssignment.agent);
    });
  });
