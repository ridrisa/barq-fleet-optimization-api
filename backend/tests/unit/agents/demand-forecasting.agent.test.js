/**
 * Unit Tests for demand-forecasting.agent.js
 */

const DemandForecasting.agent = require('../../../src/agents/demand-forecasting.agent.js');

describe('demand forecasting.agent Agent', () => {
  let agent;

  beforeEach(() => {
    agent = new DemandForecasting.agent();
  });
  ...
  describe('Constructor', () => {
    test('should initialize successfully', () => {
      ...
      expect(agent).toBeInstanceOf(DemandForecasting.agent);
    });
  });
