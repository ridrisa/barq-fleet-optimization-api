/**
 * Unit Tests for formatting.agent.js
 */

const Formatting.agent = require('../../../src/agents/formatting.agent.js');

describe('formatting.agent Agent', () => {
  let agent;

  beforeEach(() => {
    agent = new Formatting.agent();
  });
  ...
  describe('Constructor', () => {
    test('should initialize successfully', () => {
      ...
      expect(agent).toBeInstanceOf(Formatting.agent);
    });
  });
