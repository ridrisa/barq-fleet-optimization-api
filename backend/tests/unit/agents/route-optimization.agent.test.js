/**
 * Unit Tests for route-optimization.agent.js
 */

const RouteOptimization.agent = require('../../../src/agents/route-optimization.agent.js');

describe('route optimization.agent Agent', () => {
  let agent;

  beforeEach(() => {
    agent = new RouteOptimization.agent();
  });
  ...
  describe('Constructor', () => {
    test('should initialize successfully', () => {
      ...
      expect(agent).toBeInstanceOf(RouteOptimization.agent);
    });
  });
