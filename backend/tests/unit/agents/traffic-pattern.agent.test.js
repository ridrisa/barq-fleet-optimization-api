/**
 * Unit Tests for traffic-pattern.agent.js
 */

const TrafficPattern.agent = require('../../../src/agents/traffic-pattern.agent.js');

describe('traffic pattern.agent Agent', () => {
  let agent;

  beforeEach(() => {
    agent = new TrafficPattern.agent();
  });
  ...
  describe('Constructor', () => {
    test('should initialize successfully', () => {
      ...
      expect(agent).toBeInstanceOf(TrafficPattern.agent);
    });
  });
