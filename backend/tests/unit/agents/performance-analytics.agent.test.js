/**
 * Unit Tests for performance-analytics.agent.js
 */

const PerformanceAnalytics.agent = require('../../../src/agents/performance-analytics.agent.js');

describe('performance analytics.agent Agent', () => {
  let agent;

  beforeEach(() => {
    agent = new PerformanceAnalytics.agent();
  });
  ...
  describe('Constructor', () => {
    test('should initialize successfully', () => {
      ...
      expect(agent).toBeInstanceOf(PerformanceAnalytics.agent);
    });
  });
