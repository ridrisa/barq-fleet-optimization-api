/**
 * Unit Tests for customer-communication.agent.js
 */

const CustomerCommunication.agent = require('../../../src/agents/customer-communication.agent.js');

describe('customer communication.agent Agent', () => {
  let agent;

  beforeEach(() => {
    agent = new CustomerCommunication.agent();
  });
  ...
  describe('Constructor', () => {
    test('should initialize successfully', () => {
      ...
      expect(agent).toBeInstanceOf(CustomerCommunication.agent);
    });
  });
