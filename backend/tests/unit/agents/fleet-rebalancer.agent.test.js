/**
 * Unit Tests for fleet-rebalancer.agent.js
 */

const FleetRebalancer.agent = require('../../../src/agents/fleet-rebalancer.agent.js');

describe('fleet rebalancer.agent Agent', () => {
  let agent;

  beforeEach(() => {
    agent = new FleetRebalancer.agent();
  });
  ...
  describe('Constructor', () => {
    test('should initialize successfully', () => {
      ...
      expect(agent).toBeInstanceOf(FleetRebalancer.agent);
    });
  });
