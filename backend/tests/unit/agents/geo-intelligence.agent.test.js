/**
 * Unit Tests for geo-intelligence.agent.js
 */

const GeoIntelligence.agent = require('../../../src/agents/geo-intelligence.agent.js');

describe('geo intelligence.agent Agent', () => {
  let agent;

  beforeEach(() => {
    agent = new GeoIntelligence.agent();
  });
  ...
  describe('Constructor', () => {
    test('should initialize successfully', () => {
      ...
      expect(agent).toBeInstanceOf(GeoIntelligence.agent);
    });
  });
