-- Database Schema for BARQ Logistics System
...
CREATE TABLE IF NOT EXISTS zones (
  ...
  available_services service_type[] DEFAULT ARRAY['BARQ', 'BULLET'],
...
-- Insert default zones for major Saudi cities
INSERT INTO zones (name, zone_type, boundary, center_point, available_services) VALUES
  ('Riyadh Central', 'service_area',
   ST_GeogFromText('POLYGON((46.6 24.65, 46.8 24.65, 46.8 24.78, 46.6 24.78, 46.6 24.65))'),
   ST_GeogFromText('POINT(46.7136 24.7136)'),
   ARRAY['BARQ', 'BULLET']),

  ('Jeddah Central', 'service_area',
   ST_GeogFromText('POLYGON((39.1 21.4, 39.3 21.4, 39.3 21.6, 39.1 21.6, 39.1 21.4))'),
   ST_GeogFromText('POINT(39.1925 21.4858)'),
   ARRAY['BARQ', 'BULLET'])
